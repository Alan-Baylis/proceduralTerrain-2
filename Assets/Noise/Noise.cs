...
public static class Noise : object{
	...
	public static float Sum (NoiseMethod method, Vector3 point, float frequency, int octaves, float lacunarity, float gain) {
	...
	public static float Sum (NoiseMethod method, Vector3 point, float frequency, float octaves, float lacunarity, float gain) {
		float sum = method(point, frequency);
		float amplitude = 1f;
		float range = 1f;
		for (int o = 1; o < octaves; o++) {
